...
import {DONOR_FORGOT_PASSWORD} from '../redux/actions/authActions';
;
...
return{
    ...
    Update:(password,token,props)=>{dispatch(DONOR_FORGOT_PASSWORD(password,token,props))}
}
}
...
export default connect(null,mapDispatchToProps)(Donor_Forgot);